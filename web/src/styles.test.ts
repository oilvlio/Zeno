...
describe('homepage and admin shell layout', () => {
  ...
  it('uses the same slightly translucent surface for every expandable control', () => {
    ...
    expect(styles).toMatch(/\.admin-select-popover\s*\{[^}]*background: var\(--zeno-popover-bg\);[^}]*backdrop-filter: blur\(var\(--zeno-popover-blur\)\) saturate\(1\.04\);[^}]*\}/)
    expect(styles).toMatch(/\.admin-date-popover\s*\{[^}]*background: var\(--zeno-popover-bg\);[^}]*backdrop-filter: blur\(var\(--zeno-popover-blur\)\) saturate\(1\.04\);[^}]*\}/)
    expect(styles).toMatch(/\.admin-date-option-panel\s*\{[^}]*background: var\(--zeno-popover-bg\);[^}]*backdrop-filter: blur\(var\(--zeno-popover-blur\)\) saturate\(1\.04\);[^}]*\}/)
    ...
    expect(styles).toMatch(/\.admin-install-platforms\s*\{[^}]*background: var\(--zeno-popover-bg\);[^}]*backdrop-filter: blur\(var\(--zeno-popover-blur\)\) saturate\(1\.04\);[^}]*\}/)
  })
