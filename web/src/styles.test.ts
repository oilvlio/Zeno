...
describe('homepage and admin shell layout', () => {
  ...
  it('keeps theme and utility popovers legible on their themed translucent surfaces', () => {
    ...
    expect(baseStyles).toMatch(/\.theme-menu-popover,\s*\.admin-select-popover,\s*\.admin-install-platforms,\s*\.admin-date-popover\s*\{[^}]*background: var\(--zeno-overlay-surface\);[^}]*box-shadow: var\(--zeno-overlay-shadow\);[^}]*backdrop-filter: var\(--zeno-overlay-filter\);[^}]*\}/)
...
describe('state history layout', () => {
  ...
  it('keeps every detail-page control and nested card on the outer single blur layer', () => {
    ...
    expect(baseStyles).toMatch(/\.theme-menu-popover,\s*\.admin-select-popover,\s*\.admin-install-platforms,\s*\.admin-date-popover\s*\{[^}]*background: var\(--zeno-overlay-surface\);[^}]*\}/)
