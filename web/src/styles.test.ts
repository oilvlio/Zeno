...
describe('homepage and admin shell layout', () => {
  ...
  it('uses four balanced homepage summary cards without duplicate metrics', () => {
    expect(styles).toContain('.home-summary__status')
    expect(styles).toContain('.home-summary__cost')
    expect(styles).toContain('.home-summary__status-heading')
    expect(styles).toContain('.home-summary__status-label')
    expect(styles).toContain('.home-summary__status-dot')
    expect(styles).toContain('.home-summary__cost-heading')
    expect(styles).toContain('.home-summary__cost-value')
    expect(styles).toContain('.home-summary__status-track')
    expect(styles).toContain('.home-summary__network')
    expect(styles).toContain('grid-template-columns: repeat(4, minmax(0, 1fr))')
    expect(styles).toContain('--summary-accent')
    expect(styles).toContain('.home-summary__network--upload')
    expect(styles).toContain('.home-summary__network--download')
    expect(styles).toContain('.home-summary__status-value strong')
    expect(styles).toContain('.home-summary__cost-value strong')
    expect(styles).toContain('.home-summary__network-total')
    expect(styles).toMatch(/\.home-summary__status\s*\{[^}]*display: flex;[^}]*flex-direction: column;[^}]*padding: 12px 14px;[^}]*\}/)
    expect(styles).toMatch(/\.home-summary__network-icon\s*\{[^}]*width: 18px;[^}]*height: 18px;[^}]*border-radius: 0;[^}]*background: transparent;[^}]*\}/)
    ...
    expect(styles).toMatch(/\.home-currency-select__value\s*\{[^}]*font-size: 10px;[^}]*font-weight: 400;[^}]*\}/)
    ...
    expect(styles).toContain('background: color-mix(in srgb, var(--background) 96%, var(--blue) 4%)')
    expect(styles).toContain('backdrop-filter: blur(28px) saturate(1.08)')
    ...
    expect(styles).toMatch(/\.home-summary__status\s*\{[^}]*--summary-accent: var\(--green\);[^}]*display: flex;[^}]*font-variant-numeric: tabular-nums;[^}]*\}/)
    expect(styles).toMatch(/\.home-summary__cost\s*\{[^}]*--summary-accent: var\(--orange\);[^}]*display: flex;[^}]*font-variant-numeric: tabular-nums;[^}]*\}/)
    expect(styles).toMatch(/\.home-summary__cost-icon\s*\{[^}]*width: 18px;[^}]*height: 18px;[^}]*color: var\(--orange\);[^}]*\}/)
    ...
    expect(styles).toMatch(/\.home-summary__status-heading\s*\{[^}]*justify-content: space-between;[^}]*gap: 12px;[^}]*font-size: 11px;[^}]*\}/)
    expect(styles).toMatch(/\.home-summary__status-label\s*\{[^}]*display: inline-flex;[^}]*gap: 7px;[^}]*\}/)
    expect(styles).toMatch(/\.home-summary__status-dot\s*\{[^}]*width: 8px;[^}]*height: 8px;[^}]*background: var\(--green\);[^}]*\}/)
    expect(styles).toMatch(/\.home-summary__cost-heading\s*\{[^}]*gap: 8px;[^}]*font-size: 11px;[^}]*font-weight: 400;[^}]*\}/)
    expect(styles).toMatch(/\.home-summary__network-heading\s*\{[^}]*gap: 8px;[^}]*\}/)
    expect(styles).toMatch(/\.home-summary__tile\s*\{[^}]*min-height: 88px;[^}]*border-radius: var\(--radius-field\);[^}]*\}/)
    expect(styles).toMatch(/\.home-summary__status\s*\{\s*padding: 10px 11px;\s*\}/)
    expect(styles).toMatch(/\.home-summary__network-rate strong\s*\{\s*font-size: clamp\(15px, 5vw, 20px\);\s*\}/)
    expect(styles).not.toContain('.home-summary__status { grid-column: 1 / -1; }')
    ...
    expect(styles).not.toContain('.home-summary__metric')
...
describe('Kulin-inspired color polish', () => {
  ...
  it('uses solid accent colors without gradients and keeps key identity emphasized', () => {
    expect(styles).toContain('.home-summary__status-value strong')
    expect(styles).toContain('.home-summary__cost-value strong')
    expect(styles).toContain('.home-summary__network-rate > span')
    ...
    expect(styles).toContain('.home-summary__network-total dd')
    expect(styles).toContain('font-size: clamp(25px, 2.3vw, 32px)')
    expect(styles).toContain('font-size: clamp(21px, 2.15vw, 27px)')
