...
describe('Kulin-inspired color polish', () => {
  ...
  it('uses solid accent colors without gradients and keeps key identity emphasized', () => {
    ...
    expect(styles).toMatch(/\.detail-traffic-values\s*\{[^}]*align-items:\s*center;[^}]*column-gap:\s*18px;/)
    expect(styles).toMatch(/\.detail-traffic-value\s*\{[^}]*align-items:\s*center;[^}]*gap:\s*5px;[^}]*min-width:\s*0;/)
