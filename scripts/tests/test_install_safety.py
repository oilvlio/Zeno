...
class InstallSafetyTest(unittest.TestCase):
    ...
    def test_release_workflow_publishes_github_signed_image_attestation(self):
        ...
        self.assertIn("go-version: '1.26.6'", ci_workflow)
        ...
        self.assertIn('golang:1.26.6-bookworm@sha256:116d58cbd88c1297624acc6e967a060012422bacf9930927e23fb719189c6f36', dockerfile)
