...
func extendedHistoryWindow(window latencyWindow) bool {
	return window.Name == "3d" || window.Name == "7d" || window.Name == "30d"
}
...
var latencyWindowVariants = map[string][2]latencyWindow{
	...
	"3d":  {{Name: "3d", Samples: 24, Step: 3 * time.Hour}, {Name: "3d", Samples: 1440, Step: 3 * time.Minute}},
...
func resolveStateWindow(rangeName string) (latencyWindow, bool) {
	...
	case "3d":
		return latencyWindow{Name: "3d", Samples: 144, Step: 30 * time.Minute}, true
	case "7d":
