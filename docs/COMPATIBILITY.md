...
| --- | --- | --- | --- |
| v1.0.7 | v0.6.6 | 支持 | 当前稳定组合 |
| v1.0.7 | v0.6.5 | 支持 | 现有 v0.6.5 Agent 可继续上报并独立升级 |
| v1.0.6 | v0.6.6 | 支持 | 上一稳定组合 |
...
| --- | --- | --- | --- |
| v1.0.7 | v0.6.6 | Supported | Current stable combination |
| v1.0.7 | v0.6.5 | Supported | Existing v0.6.5 Agents remain supported and can upgrade independently |
| v1.0.6 | v0.6.6 | Supported | Previous stable combination |
