...
| --- | --- | --- | --- |
| v1.9.7 | v0.6.6 | 支持 | 当前稳定组合；优化服务器详情进入与完整延迟图加载，无协议字段或数据库结构变更 |
| v1.9.7 | v0.6.5 | 支持 | 现有 v0.6.5 Agent 可继续上报并独立升级 |
| v1.9.6 | v0.6.6 | 支持 | 上一稳定组合 |
...
| --- | --- | --- | --- |
| v1.9.7 | v0.6.6 | Supported | Current stable combination; improves server-detail navigation and full latency-chart loading, with no protocol-field or database-schema changes |
| v1.9.7 | v0.6.5 | Supported | Existing v0.6.5 Agents remain supported and can upgrade independently |
| v1.9.6 | v0.6.6 | Supported | Previous stable combination |
